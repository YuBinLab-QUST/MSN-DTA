...
class BuiltVocab(object):
    def __init__(self, counter, max_size=None, min_freq=1, specials=['<pad>', '<oov>'], vectors=None, unk_init=None, vectors_cache=None):
        self.freqs = counter
        ...
        if vectors is not None:
            ...
            assert unk_init is None and vectors_cache is not None
...
def main():
    ...
    parser.add_argument('--corpus_path', '-c', type=str, default='../data/protein_corpus.txt',
