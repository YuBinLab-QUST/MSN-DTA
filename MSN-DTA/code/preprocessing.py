...
VOCAB_PROTEIN = { "A": 1, "C": 2, "B": 3, "E": 4, "D": 5, "G": 6, "F": 7, "I": 8, "H": 9, "K": 10, "M": 11, "L": 12,
...
class PreDataset(InMemoryDataset):
    ...
    def process(self):
        ...
        print('Graph construction finish. Saving to file.')
...
if __name__ == "__main__":
    PreDataset('../data/davis')
    PreDataset('../data/kiba')
